package br.com.ifsp.tickets.infra.contexts.administrative.user.contexts.upsert.email;
...
import br.com.ifsp.tickets.domain.administrative.user.email.UpsertEmailID;
import br.com.ifsp.tickets.domain.administrative.user.vo.EmailAddress;
import br.com.ifsp.tickets.infra.contexts.administrative.user.contexts.upsert.email.persistence.UpsertEmailJpaEntity;
import br.com.ifsp.tickets.infra.contexts.administrative.user.contexts.upsert.email.persistence.UpsertEmailRepository;
