...
public class User extends Entity<UserID> {
    ...
    protected User(UserID userID, String name, Set<Role> roles, Email email, PhoneNumber phoneNumber, String username, String password, CPF cpf, Date birthDate, Date passwordDate, boolean active, CompanyID companyID) {
        super(userID);
        this.name = name;
        this.roles = roles;
        this.email = email;
    ...
    public static User with(UserID userID, String name, Set<Role> roles, Email email, PhoneNumber phoneNumber, String username, String password, CPF cpf, Date birthDate, Date passwordDate, boolean active, CompanyID companyID) {
        return new User(userID, name, roles, email, phoneNumber, username, password, cpf, birthDate, passwordDate, active, companyID);
    }

    public static User newUser(String name, Set<Role> roles, String email, String phoneNumber, String username, String password, CPF cpf, Date birthDate) {
